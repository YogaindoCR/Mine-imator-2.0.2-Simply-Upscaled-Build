...
function macros()
{
	...
	#macro mineimator_version_sub		"Simply Upscaled Build 1.0.14"	// Mod name and version (e.g. "Community Build 1.0.0")
	...
	#macro mineimator_version_date		"2026.6.17"
	#macro minecraft_version			"26.2" // 26.2 || 1.21.5
