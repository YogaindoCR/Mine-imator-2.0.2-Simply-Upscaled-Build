	...
	json_save_object_start()
		...
		if (type_is_shape(type))
		{
			json_save_object_start("shape")
				...
				json_save_var("major_size", shape_major_size)
				json_save_var("minor_size", shape_minor_size)
				json_save_var("subdivision", shape_subdivision)
				json_save_var("morph", shape_morph)
