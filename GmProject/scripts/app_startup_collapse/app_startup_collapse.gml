...
function app_startup_collapse()
{
	...
	collapse_register("indirectdenoiser")
	...
	collapse_register("extrasettings")
	...
	collapse_register("copyconstraint")
	...
	collapse_register("modifier")
	collapse_register("modifiershake")
	collapse_register("modifierframeskip")
