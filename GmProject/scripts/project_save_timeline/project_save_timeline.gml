	...
	json_save_object_start()
		...
		if (value_type[e_value_type.PATH])
		{
			json_save_object_start("path")
				...
				json_save_var_bool("shape_tex_fixed", path_shape_tex_fixed)
				json_save_var("shape_tex_hoffset", path_shape_tex_hoffset)
				json_save_var("shape_tex_voffset", path_shape_tex_voffset)
				json_save_var("shape_tex_hrepeat", path_shape_tex_hrepeat)
				json_save_var("shape_tex_vrepeat", path_shape_tex_vrepeat)
				json_save_var_bool("shape_tex_hmirror", path_shape_tex_hmirror)
				json_save_var_bool("shape_tex_vmirror", path_shape_tex_vmirror)
