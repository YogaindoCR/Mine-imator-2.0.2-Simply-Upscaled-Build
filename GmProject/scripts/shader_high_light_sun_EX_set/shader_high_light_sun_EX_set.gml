/// shader_high_light_sun_EX_set()

function shader_high_light_sun_EX_set()
{
	...
	render_set_uniform("uLightSize", (app.background_sunlight_angle / 32.0) * app.project_render_shadows_blur)
