...
function app_update_animate(force = false)
{
	...
	if (bgobject)
	{
		...
		*/
		...
		background_godray						= bgobject.value[e_value.BG_GODRAY]
		background_godray_strength				= bgobject.value[e_value.BG_GODRAY_STRENGTH]
		background_godray_density				= bgobject.value[e_value.BG_GODRAY_DENSITY]
