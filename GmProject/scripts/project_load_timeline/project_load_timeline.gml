...
function project_load_timeline(map)
{
	...
	with (new_obj(obj_timeline))
	{
		...
		if (ds_map_valid(pathmap))
		{
			...
			path_shape_tex_hoffset = value_get_real(pathmap[?"shape_tex_hoffset"], path_shape_tex_hoffset)
			path_shape_tex_voffset = value_get_real(pathmap[?"shape_tex_voffset"], path_shape_tex_voffset)
			path_shape_tex_hrepeat = value_get_real(pathmap[?"shape_tex_hrepeat"], path_shape_tex_hrepeat)
			path_shape_tex_vrepeat = value_get_real(pathmap[?"shape_tex_vrepeat"], path_shape_tex_vrepeat)
			path_shape_tex_hmirror = value_get_real(pathmap[?"shape_tex_hmirror"], path_shape_tex_hmirror)
			path_shape_tex_vmirror = value_get_real(pathmap[?"shape_tex_vmirror"], path_shape_tex_vmirror)
