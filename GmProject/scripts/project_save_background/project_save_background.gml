...
function project_save_background()
{
	json_save_object_start("background")
		...
		*/
		...
		json_save_var("sunlight_specular_strength", background_sunlight_specular_strength)
		...
		json_save_var_color("dry_foliage_color", background_dry_foliage_color)
		...
		json_save_var_bool("fog_height_show", background_fog_height_show)
