...
function project_save_project()
{
	json_save_object_start("project")
		...
		json_save_var_bool("custom_thumbnail", project_custom_thumbnail)
		...
		json_save_var("render_settings", project_render_settings)
		json_save_var("tempo", project_tempo)
		json_save_var("composition_guide", project_composition_guide)
		json_save_var("grid_rows", project_grid_rows)
		json_save_var("grid_columns", project_grid_columns)
		json_save_var("grid_alpha", project_grid_alpha)
		json_save_var("time_elapsed", project_time_elapsed)
		json_save_var("time_record_keyframes", time_record_keyframes)
		...
		json_save_object_start("timeline")
			...
			json_save_var_bool("record_keyframes", timeline_record_keyframes)
