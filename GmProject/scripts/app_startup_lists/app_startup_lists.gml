...
function app_startup_lists()
{
	...
	ds_list_add(value_name_list,
		...
		"CAM_DISTORT_AMOUNT",
		"CAM_BLACK_LINES",
		"CAM_BLACK_LINES_SIZE",
		"CAM_BLACK_LINES_ROTATION",
		"CAM_BLACK_LINES_OFFSET_Y",
		"CAM_BLACK_LINES_COLOR",
		"CAM_VERTEX_SNAP",
		"CAM_VERTEX_SNAP_AMOUNT",
		"CAM_HEAT_DISTORTION",
		...
		"CAM_OUTLINE_COLOR",
		"CAM_OUTLINE_RADIUS",
		"CAM_OUTLINE_STRENGTH",
		"CAM_OUTLINE_DEPTH_THRESHOLD",
		"CAM_OUTLINE_DEPTH_THRESHOLD_FADE",
		"CAM_OUTLINE_NORMAL",
		...
		"MODIFIER_SHAKE_KEYFRAME_INFLUENCE",
		"MODIFIER_FRAMESKIP",
