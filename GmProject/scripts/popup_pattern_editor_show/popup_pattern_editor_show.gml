...
function popup_pattern_editor_show(obj)
{
	with (popup_pattern_editor)
	{
		...
		with (pattern_edit)
		{
			if (instance_exists(other.pattern_edit_preview) || other.pattern_edit_preview != null)
			{
				with (other.pattern_edit_preview)
					temp_event_destroy()
			}
			else
			{
				other.pattern_edit_preview = new_obj(obj_template)
				
				with (other.pattern_edit_preview)
					temp_event_create()
			}
			
			temp_copy(other.pattern_edit_preview)
