...
function project_load_project(map)
{
	...
	project_custom_thumbnail = value_get_real(map[?"custom_thumbnail"], project_custom_thumbnail)
	...
	project_composition_guide = value_get_real(map[?"composition_guide"], project_composition_guide)
